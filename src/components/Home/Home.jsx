    ...
    <Topnavbar/>
      ...
      >
        <Heading fontSize={"28px"} fontWeight={"400"} mt={"1rem"} mb={"0.5rem"}>
          grocery-deliveryapp – online grocery store
        </Heading>
        <Box w={"100%"} fontSize={"14px"} fontWeight={"350"}>
          <Text textAlign={"left"}>
            ...
            megastore, grocery.com, brings a whopping 20000+ products with
            more than 1000 brands, to over 4 million happy customers. From
            household cleaning products to beauty and makeup, grocery-deliveryapp has
            everything you need for your daily needs. grocery-deliveryapp.com is
            ...
            along with great savings, and you will realize that grocery-deliveryapp-
            ...
            <ul>
              <li>
                <Text>
                  ...
                  late shift, grocery-deliveryapp caters to every schedule.
                </Text>
              </li>
              <li>
                <Text>
